...
# Import the packet count analyzer class
from scripts.tsim_packet_count_analyzer import TsimPacketCountAnalyzer
...
class TsimMultiServiceTester:
    ...
    def __init__(self, source_ip: str, source_port: Optional[int], dest_ip: str, 
        ...
        # Initialize packet count analyzer
        self.packet_analyzer = TsimPacketCountAnalyzer(verbose=(verbose > 1))
    ...
    def analyze_packet_counts(self, iptables_before: Dict[str, Any], 
        ...
        for router in iptables_before.keys():
            ...
            try:
                ...
                # Use the packet analyzer class method directly
                analysis = self.packet_analyzer.compare_packet_counts(
                    before_data,
                    after_data,
                    router_name=router,
